...
#    s = load_scan('/Users/wuzhenglin/Python_nice/SAL_LUNG/train_data/h')
#    print len(s)
    
    
#    path = '/Users/wuzhenglin/Python_nice/SAL_LUNG/healthy/W0001'
#    
    first_patient = load('/Users/wuzhenglin/Python_nice/SAL_LUNG/train_data/h')
...
#    plt.imshow(image)
    ...
    image = normalize(first_patient_pixels)
...
#    print '5'
    print image.shape
#    
    resize_cancer = resize(image, [512, 512])
    
    print resize_cancer.shape
#  
    print resize_cancer[0].shape
#    
    plt.imshow(resize_cancer[0])
