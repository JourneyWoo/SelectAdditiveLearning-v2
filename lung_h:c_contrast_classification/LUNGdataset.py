...
#    pix_resampled_cancer, spacing_1 = resample(get_pixels_hu_cancer, slices_cancer, [1,1,1])
...
#    slices_healthy = load_scan(path_healthy)
#    get_pixels_hu_healthy = get_pixels_hu(slices_healthy)
#    pix_resampled_healthy, spacing_2 = resample(get_pixels_hu_healthy, slices_healthy, [1,1,1])
    ...
    writer= tf.python_io.TFRecordWriter("cancerANDhealthy_3.tfrecords") 
